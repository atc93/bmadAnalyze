...
int main() {
	...
	TString inRootFileName = "/nfs/gm2/data1/achapela/bmadAnalyze/timeDepMomentsAtEnd.root" ;
	...
	TH1D *h_mu_t = new TH1D("fr","Muon detection time",700000,0.5E-3,700.005) ; 
	...
	c.SaveAs("MuTime.eps") ;
	c.SaveAs("MuTime.png") ;
	TString outRootFileName = "/nfs/gm2/data1/achapela/BMAD_frs.root" ;
